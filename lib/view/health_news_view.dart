                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, children: [
                        Image.network(
                            controller.healthNewsList[index].imageUrl!),
                        Text(
                          controller.healthNewsList[index].title!,
                        ...
                        Text(
                          controller.healthNewsList[index].date!,
                          style: const TextStyle(
                            fontSize: 20,
                          ),
                        ),
                        Container(
                          ...
                          child: Text(
                            controller.healthNewsList[index].content!,
                        ...
                        Text(
                          '- ${controller.healthNewsList[index].author!}',
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
