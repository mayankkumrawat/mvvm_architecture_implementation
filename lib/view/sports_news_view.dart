                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, children: [
                        Image.network(
                            controller.sportsNewsList[index].imageUrl!),
                        Text(
                          controller.sportsNewsList[index].title!,
                        ...
                        Text(
                          controller.sportsNewsList[index].date!,
                          style: const TextStyle(
                            fontSize: 20,
                          ),
                        ),
                        Container(
                          ...
                          child: Text(
                            controller.sportsNewsList[index].content!,
                        ...
                        Text(
                          '- ${controller.sportsNewsList[index].author!}',
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
